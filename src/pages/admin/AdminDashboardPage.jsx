  ...
  >
                  <div className="flex items-center gap-3.5 min-w-0">
                    <div className="w-12 h-12 rounded-xs bg-[#F3EFEA] overflow-hidden shrink-0 border border-[#E0D9CE]">
                      {specimen.photos && specimen.photos[0] ? <img
    src={specimen.photos[0].storageUrl}
    alt={specimen.scientificName}
    className="w-full h-full object-cover"
  /> : <div className="w-full h-full flex items-center justify-center text-[10px] font-mono-acc text-[#8E9990]">
                          N/A
                        </div>}
                    </div>
