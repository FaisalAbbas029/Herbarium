...
const AdminLayout = ({
  ...
  return <div className="min-h-screen bg-[#F7F5F0] flex flex-col md:flex-row text-[#1C241E]">
      {
    /* Mobile Top Navigation Bar */
  }
      <div className="md:hidden bg-[#18261D] text-[#D8E6DC] px-4 py-3 border-b border-[#2D3F33] flex items-center justify-between sticky top-0 z-30">
  ...
  >
    ...
    /* Backdrop for Mobile Menu */
      ...
      {mobileMenuOpen && <div
    className="md:hidden fixed inset-0 z-20 bg-black/50 backdrop-blur-xs"
    onClick={() => setMobileMenuOpen(false)}
  />}

      {
    /* Sidebar Navigation (Desktop Fixed / Mobile Dropdown) */
  }
      <aside
    className={`${mobileMenuOpen ? "block" : "hidden"} md:flex w-full md:w-64 bg-[#18261D] text-[#D8E6DC] flex-col justify-between shrink-0 border-r border-[#2D3F33] z-20 relative md:min-h-screen`}
  >
        <div>
          {
    /* Herbarium Branding Zone (Desktop) */
  }
  ...
  />
    ...
    /* Sidebar Footer Controls */
        ...
        <div className="p-4 border-t border-[#2D3F33] space-y-2 text-xs">
          <button
  ...
  >
    ...
    /* Desktop Header */
        ...
        <header className="hidden md:flex bg-white border-b border-[#E0D9CE] px-6 py-3.5 items-center justify-between sticky top-0 z-10">
