  ...
  return <div className="min-h-[75vh] flex items-center justify-center px-4 py-12">
    ...
    /* Header */
        ...
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-sm bg-[#1F4529] text-[#FAF8F5] mx-auto flex items-center justify-center shadow-sm">
            <FontAwesomeIcon icon={faLeaf} className="w-6 h-6 text-[#E3D8C8]" />
          </div>
    ...
    /* Notice: Invite only */
        ...
        <div className="bg-[#FAF8F5] border border-[#E0D9CE] rounded-sm p-3.5 text-xs text-[#566158] flex items-center gap-2">
          <FontAwesomeIcon icon={faShieldHalved} className="w-4 h-4 text-[#47663B] shrink-0" />
          <span>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <FontAwesomeIcon icon={faEnvelope} className="w-3.5 h-3.5 text-[#8E9990] absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="email"
                  required
                  value={email}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full pl-9 pr-10 py-2.5 text-xs sm:text-sm bg-[#FAF8F5] border border-[#C7BEB1] rounded-sm focus:outline-hidden focus:ring-1 focus:ring-[#1F4529] text-[#1C241E]"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((v) => !v)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8E9990] hover:text-[#1F4529] transition-colors"
            ...
            >
              {isLoading ? <span className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <FontAwesomeIcon icon={faArrowRight} className="w-3.5 h-3.5" />}
